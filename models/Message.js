...
const Message = {
    create: (from, to, content, callback) => {
        const query = 'INSERT INTO messages (sender_id, receiver_id, content, reactions, created_at) VALUES (?, ?, ?, ?, NOW())';
        db.query(query, [from, to, content, JSON.stringify([])], callback);
    },
